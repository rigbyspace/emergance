...
private:
    ...
    // CRITICAL FIX: Removed 'const' to allow for necessary internal state modification (if needed)
    bool is_prime_trigger(); 
    void psi_transform();
...
public:
    ...
    // CRITICAL GETTER for the constrained logging
